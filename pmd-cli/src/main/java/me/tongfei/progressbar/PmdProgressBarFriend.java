...
/**
 * This is a friend class for me.tongfei.progressbar, as TerminalUtils is
 * package-private.
 */
public final class PmdProgressBarFriend {
    ...
    public static ConsoleProgressBarConsumer createConsoleConsumer(PrintStream ps) {
        return TerminalUtils.hasCursorMovementSupport() ? new InteractiveConsoleProgressBarConsumer(ps)
