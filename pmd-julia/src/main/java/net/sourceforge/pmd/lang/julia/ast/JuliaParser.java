...
public class JuliaParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, T__7 = 8, T__8 = 9,
            ...
            COMMENTS = 18, MULTILINECOMMENTS1 = 19, MULTILINECOMMENTS2 = 20, MULTILINESTRING = 21, NL = 22,
            WHITESPACE = 23, ABSTRACT = 24, ARROWOPERATOR = 25, ASSIGNMENTOPERATOR = 26, BAREMODULE = 27, BEGIN = 28,
            BITSHIFTOPERATOR = 29, BITSTYPE = 30, BREAK = 31, CATCH = 32, CCALL = 33, CHAR = 34, CONST = 35,
            CONTINUE = 36, DO = 37, ELSE = 38, ELSIF = 39, END = 40, EXPORT = 41, EXTERNALCOMMAND = 42, FINALLY = 43,
            FOR = 44, FUNCTION = 45, GLOBAL = 46, IF = 47, IMMUTABLE = 48, IMPORT = 49, IMPORTALL = 50, INSTANCEOF = 51,
            LET = 52, LOCAL = 53, MACRO = 54, MODULE = 55, PIPEOPERATOR = 56, QUOTE = 57, RETURN = 58,
            STAGEDFUNCTION = 59, STRING = 60, STRUCT = 61, TRY = 62, TYPE = 63, TYPEALIAS = 64, USING = 65, WHERE = 66,
    ...
    public static final int RULE_main = 0, RULE_functionDefinition = 1, RULE_functionDefinition1 = 2,
            RULE_functionDefinition2 = 3, RULE_functionIdentifier = 4, RULE_whereClause = 5, RULE_functionBody = 6,
            RULE_statement = 7, RULE_beginStatement = 8, RULE_doStatement = 9, RULE_forStatement = 10,
            RULE_ifStatement = 11, RULE_letStatement = 12, RULE_macroStatement = 13, RULE_structStatement = 14,
            RULE_tryCatchStatement = 15, RULE_typeStatement = 16, RULE_whileStatement = 17, RULE_anyToken = 18;

    private static String[] makeRuleNames() {
        return new String[] { "main", "functionDefinition", "functionDefinition1", "functionDefinition2",
            "functionIdentifier", "whereClause", "functionBody", "statement", "beginStatement", "doStatement",
            "forStatement", "ifStatement", "letStatement", "macroStatement", "structStatement", "tryCatchStatement",
            "typeStatement", "whileStatement", "anyToken" };
    }
    ...
    private static String[] makeLiteralNames() {
        return new String[] { null, "'('", "')'", "'='", "'['", "']'", "'{'", "'}'", "'=>'", "'&&'", "'||'", "'=='",
            "'>='", "'<='", "'<'", "'<:'", "'>'", "'...'", null, null, null, null, null, null, "'abstract'", null, null,
            "'baremodule'", "'begin'", null, "'bitstype'", "'break'", "'catch'", "'ccall'", null, "'const'",
            "'continue'", "'do'", "'else'", "'elsif'", "'end'", "'export'", null, "'finally'", "'for'", "'function'",
            "'global'", "'if'", "'immutable'", "'import'", "'importall'", "'::'", "'let'", "'local'", "'macro'",
            "'module'", null, "'quote'", "'return'", "'stagedfunction'", null, "'struct'", "'try'", "'type'",
            "'typealias'", "'using'", "'where'", "'while'" };
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[] { null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
            null, null, null, "COMMENTS", "MULTILINECOMMENTS1", "MULTILINECOMMENTS2", "MULTILINESTRING", "NL",
            "WHITESPACE", "ABSTRACT", "ARROWOPERATOR", "ASSIGNMENTOPERATOR", "BAREMODULE", "BEGIN", "BITSHIFTOPERATOR",
            "BITSTYPE", "BREAK", "CATCH", "CCALL", "CHAR", "CONST", "CONTINUE", "DO", "ELSE", "ELSIF", "END", "EXPORT",
            "EXTERNALCOMMAND", "FINALLY", "FOR", "FUNCTION", "GLOBAL", "IF", "IMMUTABLE", "IMPORT", "IMPORTALL",
            "INSTANCEOF", "LET", "LOCAL", "MACRO", "MODULE", "PIPEOPERATOR", "QUOTE", "RETURN", "STAGEDFUNCTION",
            "STRING", "STRUCT", "TRY", "TYPE", "TYPEALIAS", "USING", "WHERE", "WHILE", "NUMERICAL", "INT_LITERAL",
            "BINARY", "OCTAL", "HEX", "FLOAT32_LITERAL", "FLOAT64_LITERAL", "HEX_FLOAT", "IDENTIFIER", "ANY",
            "STAGED_FUNCTION" };
    }
    ...
    public static class MainContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterMain(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitMain(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitMain(this);
            else
    ...
    public static class FunctionDefinitionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterFunctionDefinition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitFunctionDefinition(this);
        }
    ...
    public static class FunctionDefinition1Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterFunctionDefinition1(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitFunctionDefinition1(this);
        }
    ...
    public static class FunctionDefinition2Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterFunctionDefinition2(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitFunctionDefinition2(this);
        }
    ...
    public static class FunctionIdentifierContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterFunctionIdentifier(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitFunctionIdentifier(this);
        }
    ...
    public static class WhereClauseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterWhereClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitWhereClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitWhereClause(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionBodyContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterFunctionBody(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitFunctionBody(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitFunctionBody(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class BeginStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterBeginStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitBeginStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitBeginStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DoStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterDoStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitDoStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitDoStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ForStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterForStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitForStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitForStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class IfStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterIfStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitIfStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitIfStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class LetStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterLetStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitLetStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitLetStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MacroStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterMacroStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitMacroStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitMacroStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StructStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterStructStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitStructStatement(this);
        }
    ...
    public static class TryCatchStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterTryCatchStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitTryCatchStatement(this);
        }
    ...
    public static class TypeStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterTypeStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitTypeStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitTypeStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class WhileStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterWhileStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitWhileStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitWhileStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AnyTokenContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).enterAnyToken(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof JuliaListener)
                ((JuliaListener) listener).exitAnyToken(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof JuliaVisitor)
                return ((JuliaVisitor<? extends T>) visitor).visitAnyToken(this);
            else
                return visitor.visitChildren(this);
        }
    }
