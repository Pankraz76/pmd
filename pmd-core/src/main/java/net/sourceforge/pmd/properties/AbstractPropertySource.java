...
public abstract class AbstractPropertySource implements PropertySource {
    ...
    // TODO setProperty should probably be hidden from Rule implementations, they
    // have no business using that
    ...
    /**
     * The values for each property that were overridden here. Default property
     * values are not contained in this map. In other words, if this map doesn't
     * contain a descriptor which is in {@link #propertyDescriptors}, then it's
    ...
    public boolean equals(Object o) {
        ...
        // Convert the values to strings for comparisons. This is needed at least for
        // RegexProperties,
        ...
        propertyDescriptors.forEach(propertyDescriptor -> {
            Object value = propertyValuesByDescriptor.getOrDefault(propertyDescriptor,
        ...
        that.propertyDescriptors.forEach(propertyDescriptor -> {
            Object value = that.propertyValuesByDescriptor.getOrDefault(propertyDescriptor,
                    propertyDescriptor.defaultValue());
            @SuppressWarnings({ "unchecked", "rawtypes" })
            String valueString = ((PropertyDescriptor) propertyDescriptor).serializer().toString(value);
