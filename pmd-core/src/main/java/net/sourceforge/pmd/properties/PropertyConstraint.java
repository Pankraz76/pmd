...
public interface PropertyConstraint<T> {
    ...
    /**
     * Checks that the value conforms to this constraint. Throws if that is not the
     * case.
     *
     * @param value
    ...
    /**
     * Returns a description of the constraint imposed by this validator on the
     * values. E.g. "Should be positive", or "Should be one of A | B | C."
     *
     * <p>
    ...
    /**
     * Serializes this constraint as XML attributes, that are part of the property
     * element of a rule definition.
     *
     * <p>
     * Note: This is only used for constraints, which can be defined in a rule
     * definition in a ruleset (e.g. for XPath rules).
     * </p>
     *
     * @return a map with attribute name and attribute value, suitable to be used in
     *         XML.
     *
    ...
    /**
     * Returns a constraint that validates an {@code Optional<T>} by checking that
     * the value conforms to this constraint if it is non-empty.
     */
    ...
    /**
     * Returns a constraint that validates a collection of Ts by checking each
     * component conforms to this validator.
     *
     ...
     *
     * @param pred
     *            The predicate. If it returns false on a value, then the value is
     *            deemed to have a problem
     * @param constraintDescription
     *            Description of the constraint, see
     *            {@link PropertyConstraint#getConstraintDescription()}.
     * @param <U>
     *            Type of value to validate
     *
     * @return A new validator
     */
    static <U> PropertyConstraint<U> fromPredicate(final Predicate<? super U> pred,
            final String constraintDescription) {
        return fromPredicate(pred, constraintDescription, Collections.emptyMap());
    }

    /**
     * Builds a new constraint from a predicate, a description and xml attributes to
