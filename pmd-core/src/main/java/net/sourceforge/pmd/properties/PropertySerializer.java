...
public abstract class PropertySerializer<T> {
    ...
    /**
     * Returns the constraints that this mapper applies to values after parsing
     * them. This may be used for documentation, or to check a constraint on a value
     * that was not parsed from XML.
     *
    ...
    /**
     * Returns a new XML mapper that will check parsed values with the given
     * constraint.
     */
     ...
     *             if something goes wrong (but should be reported on the error
     *             reporter)
     */
