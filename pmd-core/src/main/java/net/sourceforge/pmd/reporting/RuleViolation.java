...
public interface RuleViolation {
    /**
     * A comparator for rule violations. This compares all exposed attributes of a
     * violation, filename first. The remaining parameters are compared in an
     * unspecified order.
     */
    Comparator<RuleViolation> DEFAULT_COMPARATOR = Comparator.comparing(RuleViolation::getFileId)
            .thenComparingInt(RuleViolation::getBeginLine).thenComparingInt(RuleViolation::getBeginColumn)
            .thenComparing(RuleViolation::getDescription, Comparator.nullsLast(Comparator.naturalOrder()))
            .thenComparingInt(RuleViolation::getEndLine).thenComparingInt(RuleViolation::getEndColumn)
            .thenComparing(rv -> rv.getRule().getName());

    /**
     * Key in {@link #getAdditionalInfo()} for the name of the class in which the
     * violation was identified.
     */
    String CLASS_NAME = "className";
    /**
     * Key in {@link #getAdditionalInfo()} for the name of the variable related to
     * the violation.
     */
    String VARIABLE_NAME = "variableName";
    /**
     * Key in {@link #getAdditionalInfo()} for the name of the method in which the
     * violation was identified.
     */
    String METHOD_NAME = "methodName";
    /**
     * Key in {@link #getAdditionalInfo()} for the name of the package in which the
     * violation was identified.
     */
    ...
    /**
     * A map of additional key-value pairs known about this violation. What data is
     * in there is language specific. Common keys supported by several languages are
     * defined as constants on this interface. The map is unmodifiable.
     */
