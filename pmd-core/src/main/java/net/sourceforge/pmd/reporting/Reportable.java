...
/**
 * Interface implemented by those objects that can be the target of a
 * {@link RuleViolation}. {@link Node}s and {@link GenericToken tokens}
...
public interface Reportable {
     ...
     * <p>
     * Use this instead of
     * {@link Node#getBeginColumn()}/{@link Node#getBeginLine()}, etc.
     */
