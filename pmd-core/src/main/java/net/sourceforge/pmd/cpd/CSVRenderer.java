...
/**
 * Renders a report to CSV. The CSV format renders each match (duplication) as a
 * single line with the following columns:
 * <ul>
 * <li>lines (optional): The number of lines the first mark of a match spans.
 * Only output if the {@code lineCountPerFile} is disabled (see ctor
 * params).</li>
 * <li>tokens: The number of duplicated tokens in a match (size of the
 * match).</li>
 * <li>occurrences: The number of duplicates in a match (number of times the
 * tokens were found in distinct places).</li>
 * </ul>
 *
 * <p>
 * Trailing each line are pairs (or triples, if {@code lineCountPerFile} is
 * enabled) of fields describing each file where the duplication was found in
 * the format {@code (start line, line count (optional), file path)}. These
 ...
 * <li>The first duplicate instance is in file {@code /var/file1} and starts at
 * line 48;</li>
 * <li>The second duplicate instance is in file {@code /var/file2} and starts at
 * line 73.</li>
 * </ul>
 * <p>
 ...
 * <li>75 duplicated tokens
 * <li>2 duplicate instances
 * <li>The first duplicate instance is in file {@code /var/file1}, starts at
 * line 48, and is 10 lines long;</li>
 * <li>The second duplicate instance is in file {@code /var/file2}, starts at
 * line 73, and is 12 lines long.</li>
 * </ul>
 */
