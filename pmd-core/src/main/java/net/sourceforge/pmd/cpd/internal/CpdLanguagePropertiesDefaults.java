...
public final class CpdLanguagePropertiesDefaults {
    ...
    /**
     * Default value for the option "cpdSkipBlocksPattern", which is only supported
     * by the CppLanguageModule.
     *
     * <p>
     * It is already needed in the CLI impl, that's why it needs to be in pmd-core,
     * and not in pmd-cpp.
     */
