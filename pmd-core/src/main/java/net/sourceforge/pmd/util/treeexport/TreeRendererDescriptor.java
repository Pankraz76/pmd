...
public interface TreeRendererDescriptor {
     ...
     * {@link #produceRenderer(PropertySource)}. Properties supported by the
     * renderer are already registered on the returned bundle.
     */
    PropertySource newPropertyBundle();

    /**
     * Returns the ID of this renderer, used to select it. The ID of a descriptor
     * should never change.
     *
     ...
     *
     * @param properties
     *            A property bundle, that should have been produced by
