...
public final class XmlErrorMessages {
    ...
    /**
     * {0}: unexpected element name; {1}: parent node name; {2}: list of allowed
    ...
    /**
     * {0}: unexpected element name; {1}: parent node name; {2}: allowed elements in
     * this context
     */
    ...
    public static final String IGNORED__DUPLICATE_CHILD_ELEMENT = "Duplicated child with name ''{0}''"
            + THIS_WILL_BE_IGNORED;
    public static final String IGNORED__DUPLICATE_PROPERTY_SETTER = "Duplicate property tag with name ''{0}''"
            + THIS_WILL_BE_IGNORED;
