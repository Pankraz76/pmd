...
public interface LanguageVersionHandler {
    ...
    /**
     * Returns additional language-specific violation suppressors. These take
     * precedence over the default suppressors (eg nopmd comment), but do not
     * replace them.
     */
    ...
    /**
     * Returns the metrics provider for this language version, or null if it has
     * none.
     */
    ...
    /**
     * Returns the designer bindings for this language version. Null is not an
     * acceptable result, use {@link DefaultDesignerBindings#getInstance()} instead.
     *
     * @since 6.20.0
     */
