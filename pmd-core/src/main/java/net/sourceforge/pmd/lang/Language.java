 ...
 * {@link LanguageRegistry}, see {@link LanguageRegistry#PMD} for instance.
 *
 * <p>
 * Language instances are extensions to the core of PMD. They can be registered
 * with a {@linkplain ServiceLoader service file} so that PMD automatically
 * finds them on the classpath.
 *
 * <p>
 * Instances of this interface are stateless and immutable after construction.
 * They mostly provide metadata about the language, like ID, name and different
 * versions that are supported.
 *
 * <p>
 * Languages should implement the interfaces {@link PmdCapableLanguage} or
 * {@link CpdCapableLanguage} to be usable by PMD or CPD, respectively.
 *
 * @see LanguageVersion
 */
public interface Language extends Comparable<Language> {
     ...
     * language without the use of acronyms, but possibly some capital letters, eg
     * {@code "Java"}. It's suitable for displaying in a GUI.
     *
    ...
    /**
     * Returns the short name of this language. This is the commonly used short form
     * of this language's name, perhaps an acronym, but possibly with special
     * characters.
     *
    ...
    /**
     * Returns the ID of this language. This is a short, alphanumeric, lowercase
     * name, eg {@code "java"}. It's used to identify the language in the ruleset
     * XML, and is also in the package name of the language module.
     *
    ...
    /**
     * If this is a dialect of another language, returns the base language. Dialects
     * are for example different flavors of XML. Dialects must share the same AST as
     * their base language. This makes it so that rules written for the base
     * language can be applied files of all dialects uniformly.
     * 
    ...
    /**
     * Returns the list of file extensions associated with this language. This list
     * is unmodifiable. Extensions do not have a '.' prefix.
     *
    ...
    /**
     * Returns whether this language handles the given file extension. The
    ...
    /**
     * Returns a complete set of supported version names for this language including
     * all aliases.
     *
     ...
     * {@linkplain LanguageVersion#getVersion() version string} is registered. Then,
     * {@link #getVersion(String) getVersion} will return a non-null value.
     *
     * @param version
     *            A version string
     *
     ...
     * {@linkplain LanguageVersion#getVersion() version string}. Returns null if no
     * such version exists.
     *
     * @param version
     *            A language version string.
     *
     * @return The corresponding LanguageVersion, {@code null} if the version string
     *         is not recognized.
     */
    ...
    /**
     * Returns the default language version for this language. This is an arbitrary
     * choice made by the PMD product, and can change between PMD releases. Every
     * language has a default version.
     *
     ...
     * {@link LanguageProcessor} for this language. The returned bundle must have
     * all supported properties already declared. See {@link PmdCapableLanguage} and
     * {@link CpdCapableLanguage} for sites where properties are passed back to the
     * language with user-provided values.
     *
     ...
     * Whenever this language is loaded into a {@link LanguageProcessorRegistry},
