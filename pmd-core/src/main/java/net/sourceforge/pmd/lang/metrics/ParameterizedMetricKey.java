...
/**
 * Represents a key parameterized with its options. Used to index memoization
 * maps.
 *
 * @param <N>
...
final class ParameterizedMetricKey<N extends Node, R extends Number>
    ...
    public boolean equals(Object o) {
        return o instanceof ParameterizedMetricKey && ((ParameterizedMetricKey<?, ?>) o).metric.equals(metric)
     ...
     *            The options
     * @param <N>
     *            The type of node of the metric key
     *
     * @return An instance of parameterized metric key corresponding to the
     *         parameters
     */
    @SuppressWarnings("PMD.SingletonClassReturningNewInstance")
    public static <N extends Node, R extends Number> ParameterizedMetricKey<N, R> getInstance(Metric<N, R> key,
