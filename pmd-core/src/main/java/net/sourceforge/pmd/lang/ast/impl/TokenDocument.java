...
/**
 * Token layer of a parsed file. This object is used to store state global to
 * all tokens of a single file, e.g. the text document. Not all languages
 * currently have an implementation of a token document.
 *
