...
public final class AstInfo<T extends RootNode> {
    ...
    private AstInfo(TextDocument textDocument, T rootNode, LanguageProcessorRegistry lpReg,
    ...
    /**
     * Returns the text document that was parsed. This has info like language
     * version, etc.
     */
    ...
    /**
     * Returns the map of line numbers to suppression / review comments. Only single
     * line comments are considered, that start with the configured
     ...
     *
     * <p>
     * This map is later used to determine, if a violation is being suppressed. It
     * is suppressed, if the line of the violation is contained in this suppress
     * map.
     *
    ...
    public AstInfo<T> withSuppressMap(Map<Integer, String> map) {
        return new AstInfo<>(textDocument, rootNode, lpReg, map);
    }
