...
class ZipFileFingerprinterTest extends AbstractClasspathEntryFingerprinterTest {
    ...
    @Test void zipEntryMetadataDoesNotAffectFingerprint() throws IOException {
    ...
    @Test void zipEntryOrderDoesNotAffectFingerprint() throws IOException {
    ...
    @Test void nonClassZipEntryDoesNotAffectFingerprint() throws IOException {
        final File zipFile = tempDir.resolve("foo.jar").toFile();
        final ZipEntry fooEntry = new ZipEntry("lib/Foo.class");
    ...
    @Override protected ClasspathEntryFingerprinter newFingerPrinter() {
        return new ZipFileFingerprinter();
    }

    @Override protected String[] getValidFileExtensions() {
        return new String[]{"zip", "jar"};
    }

    @Override protected String[] getInvalidFileExtensions() {
        return new String[]{"xml"};
    }

    @Override protected File createValidNonEmptyFile() throws IOException {
        final File zipFile = tempDir.resolve("foo.jar").toFile();
