...
class RuleSetReferenceIdTest {
    ...
    @Test void testRelativeWithAbsoluteRuleSet() {
    ...
    @Test void testConstructorGivenHttpUrlIdSucceedsAndProcessesIdCorrectly() {
    ...
    @Test void testOldSimpleRuleSetReferences() {
     ...
     */
    @Test void testMultipleRulesWithSpaces() {
    ...
    @Test void testOneFullRuleSetURL() {
    ...
    @Test void testFullRuleSetURLAndRule() {
        List<RuleSetReferenceId> references = RuleSetReferenceId
    ...
    @Test void testRelativePathRuleSet() {
    ...
    @Test void testFooRules() throws Exception {
    ...
    @Test void testNullRulesetString() throws Exception {
