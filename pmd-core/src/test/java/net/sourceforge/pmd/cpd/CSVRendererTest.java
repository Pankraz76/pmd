...
class CSVRendererTest {
    ...
    void testLineCountPerFile() throws IOException {
        ...
        String expectedReport = "tokens,occurrences" + System.lineSeparator() + "75,2,48,10,"
                + CpdTestUtils.FOO_FILE_ID.getAbsolutePath() + ",73,20," + CpdTestUtils.BAR_FILE_ID.getAbsolutePath()
    ...
    void testFilenameEscapes() throws IOException {
        ...
        renderer.render(builder.build(), sw);
        String report = sw.toString();
        String expectedReport = "lines,tokens,occurrences" + System.lineSeparator() + "10,75,2,48,\""
                + foo.getAbsolutePath() + "\",73,\"" + bar.getAbsolutePath() + "\"" + System.lineSeparator();
        assertEquals(expectedReport, report);
    }
