...
class CpdXsltTest {
     ...
     * 
     * <project> <target name="cpdxslt"> <xslt
     * in="src/test/resources/net/sourceforge/pmd/cpd/SampleCpdReport.xml"
     * style="etc/xslt/cpdhtml.xslt" out="cpd.html" /> </target> </project>
     */

    @Test
    void cpdhtml() throws Exception {
        String result = runXslt("cpdhtml.xslt");
        String expected = IOUtil.readToString(CpdXsltTest.class.getResourceAsStream("ExpectedCpdHtmlReport.html"),
    ...
    void cpdhtmlv2() throws Exception {
        ...
        String expected = IOUtil.readToString(CpdXsltTest.class.getResourceAsStream("ExpectedCpdHtmlReport-v2.html"),
                StandardCharsets.UTF_8);
        assertEquals(expected, result);
    }
    ...
    private String runXslt(String stylesheet) throws Exception {
        ...
        // note: using the default JDK factory, otherwise we would use Saxon from PMD's
        // classpath
