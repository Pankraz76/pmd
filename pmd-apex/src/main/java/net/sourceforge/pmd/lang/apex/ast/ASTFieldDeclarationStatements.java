...
public final class ASTFieldDeclarationStatements extends AbstractApexNode.Single<FieldDeclarationGroup> {
    ...
    /**
     * This returns the first level of the type arguments. If there are nested types
     * (e.g. {@code List<List<String>>}), then these returned types contain
     * themselves type arguments.
     *
     * <p>
     * Note: This method only exists for this AST type and in no other type, even
     * though type arguments are possible e.g. for
     * {@link ASTVariableDeclaration#getType()}.
     */
