...
class AntlrVersionTest {
    /**
     * <p>
     * In PMD, we provide the antlr4-runtime dependency on our own and overwrite the
     * version that would be inherited transitively. This might cause problems for
     * parsers that are not generated by us, like apex-dev-tools:apex-parser. This
     * might be generated with a different version, which results in stderr messages
     * created by
     * {@link org.antlr.v4.runtime.RuntimeMetaData#checkVersion(String, String)}.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * This test serves as a safety guard, in case we update our own antlr
     * dependency to some incompatible version.
     * </p>
     *
     * @see <a href="https://github.com/pmd/pmd/issues/4678">[apex] Warning messages
     *      about ANTLR version mismatch #4678</a>
     */
    @Test
