...
class ApexTreeDumpTest extends BaseTreeDumpTest {
    ...
    @Test void safeNavigationOperator() {
        doTest("SafeNavigationOperator");
    }

    @Test void userEnumType() {
        doTest("UserEnumType");
    }

    @Test void innerClassLocations() {
        doTest("InnerClassLocations");
    }

    @Test void nullCoalescingOperator() {
     ...
     */
    @Test void convertCurrencyInSoqlAndSosl() {
     ...
     */
    @Test void castExpressionTypeInfo() {
