...
/**
 * @deprecated Since 7.8.0. This class was never intended to be generated. It
...
public class CocoParser extends Parser {
    ...
    public static final int AFTER = 1, AS = 2, ASSERT = 3, ATTRIBUTE = 4, BECOME = 5, BREAK = 6, CASE = 7,
            COMPONENT = 8, CONTINUE = 9, ELSE = 10, ENUM = 11, ENTRY = 12, EXECUTION = 13, EXIT = 14, EXTERNAL = 15,
            FINAL = 16, FOR = 17, FUNCTION = 18, IF = 19, ILLEGAL = 20, IMPORT = 21, IN = 22, INIT = 23, INSTANCE = 24,
            MACHINE = 25, MATCH = 26, MUT = 27, MUTATING = 28, NONDET = 29, OFFER = 30, OPTIONAL = 31, OTHERWISE = 32,
            OUT = 33, OUTGOING = 34, PERIODIC = 35, PORT = 36, PRIVATE = 37, RETURN = 38, SIGNAL = 39, SPONTANEOUS = 40,
            STATE = 41, STATIC = 42, STRUCT = 43, TYPE = 44, UNQUALIFIED = 45, VAL = 46, VAR = 47, WHERE = 48,
            WHILE = 49, IDENTIFIER = 50, AT = 51, ASSIGN = 52, COLON = 53, LP = 54, RP = 55, LC = 56, RC = 57, LB = 58,
            RB = 59, COMMA = 60, SEMI = 61, DOT = 62, LT = 63, GT = 64, MUL = 65, DIV = 66, MINUS = 67, MOD = 68,
            PLUS = 69, IMPL = 70, ARROW = 71, AMP = 72, QM = 73, PIPE = 74, EXCL = 75, ELLIP = 76, EQ = 77, NE = 78,
            OR = 79, AND = 80, LE = 81, GE = 82, WHITESPACE = 83, NEWLINE = 84, LINE_COMMENT = 85, BLOCK_COMMENT = 86,
            INTEGER = 87, BACKTICK_LITERAL = 88, CHAR_LITERAL = 89, STRING_LITERAL = 90;
    public static final int RULE_module = 0, RULE_declaration = 1, RULE_attribute = 2, RULE_attributeDeclaration = 3,
            ...
            RULE_externalConstantDeclaration = 13, RULE_externalTypeDeclaration = 14, RULE_externalTypeElement = 15,
            RULE_externalFunctionDeclaration = 16, RULE_genericTypeDeclaration = 17, RULE_genericTypes = 18,
            RULE_genericType = 19, RULE_enumElement = 20, RULE_enumCase = 21, RULE_caseParameters = 22,
            RULE_caseParameter = 23, RULE_structElement = 24, RULE_fieldDeclaration = 25, RULE_componentElement = 26,
            ...
            RULE_nondetExpression_ = 33, RULE_fieldAssignments = 34, RULE_fieldAssignment = 35, RULE_nondetClauses = 36,
            RULE_nondetClause = 37, RULE_matchClauses = 38, RULE_matchClause = 39, RULE_pattern = 40,
            RULE_enumCasePattern = 41, RULE_idParameterPatterns = 42, RULE_idParameterPattern = 43,
            RULE_variableDeclarationPattern = 44, RULE_parameterPatterns = 45, RULE_parameterPattern = 46,
            RULE_expressions = 47, RULE_statement = 48, RULE_declarationStatement = 49, RULE_returnStatement = 50,
            RULE_becomeStatement = 51, RULE_whileStatement = 52, RULE_forStatement = 53, RULE_breakStatement = 54,
            ...
            RULE_stateInvariant = 67, RULE_transitionDeclaration = 68, RULE_eventTransition = 69, RULE_eventSource = 70,
            RULE_spontaneousTransition = 71, RULE_timerTransition = 72, RULE_eventHandler = 73, RULE_offer = 74,
            RULE_offerClauses = 75, RULE_offerClause = 76, RULE_parameters = 77, RULE_parameter = 78,
            RULE_literalExpression_ = 79, RULE_type = 80, RULE_types = 81, RULE_dotIdentifierList = 82;

    private static String[] makeRuleNames() {
        return new String[] { "module", "declaration", "attribute", "attributeDeclaration", "importDeclaration",
            ...
            "externalFunctionDeclaration", "genericTypeDeclaration", "genericTypes", "genericType", "enumElement",
            "enumCase", "caseParameters", "caseParameter", "structElement", "fieldDeclaration", "componentElement",
            "staticMemberDeclaration", "constructorDeclaration", "expression", "blockExpression_", "ifExpression_",
            "matchExpression_", "nondetExpression_", "fieldAssignments", "fieldAssignment", "nondetClauses",
            "nondetClause", "matchClauses", "matchClause", "pattern", "enumCasePattern", "idParameterPatterns",
            "idParameterPattern", "variableDeclarationPattern", "parameterPatterns", "parameterPattern", "expressions",
            "statement", "declarationStatement", "returnStatement", "becomeStatement", "whileStatement", "forStatement",
            "breakStatement", "continueStatement", "portElement", "functionInterfaceDeclaration", "signalDeclaration",
            "stateMachineDeclaration", "stateMachineElement", "stateDeclaration", "eventStateDeclaration",
            "executionStateDeclaration", "eventStateElement", "entryFunctionDeclaration", "exitFunctionDeclaration",
    ...
    private static String[] makeLiteralNames() {
        return new String[] { null, "'after'", "'as'", "'assert'", "'attribute'", "'become'", "'break'", "'case'",
            "'component'", "'continue'", "'else'", "'enum'", "'entry'", "'execution'", "'exit'", "'external'",
            "'final'", "'for'", "'function'", "'if'", "'illegal'", "'import'", "'in'", "'init'", "'instance'",
            "'machine'", "'match'", "'mut'", "'mutating'", "'nondet'", "'offer'", "'optional'", "'otherwise'", "'out'",
            "'outgoing'", "'periodic'", "'port'", "'private'", "'return'", "'signal'", "'spontaneous'", "'state'",
            "'static'", "'struct'", "'type'", "'unqualified'", "'val'", "'var'", "'where'", "'while'", null, "'@'",
            "'='", "':'", "'('", "')'", "'{'", "'}'", "'['", "']'", "','", "';'", "'.'", "'<'", "'>'", "'*'", "'/'",
            "'-'", "'%'", "'+'", "'=>'", "'->'", "'&'", "'?'", "'|'", "'!'", "'...'", "'=='", "'!='", "'||'", "'&&'",
            "'<='", "'>='" };
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[] { null, "AFTER", "AS", "ASSERT", "ATTRIBUTE", "BECOME", "BREAK", "CASE", "COMPONENT",
            "CONTINUE", "ELSE", "ENUM", "ENTRY", "EXECUTION", "EXIT", "EXTERNAL", "FINAL", "FOR", "FUNCTION", "IF",
            "ILLEGAL", "IMPORT", "IN", "INIT", "INSTANCE", "MACHINE", "MATCH", "MUT", "MUTATING", "NONDET", "OFFER",
            "OPTIONAL", "OTHERWISE", "OUT", "OUTGOING", "PERIODIC", "PORT", "PRIVATE", "RETURN", "SIGNAL",
            "SPONTANEOUS", "STATE", "STATIC", "STRUCT", "TYPE", "UNQUALIFIED", "VAL", "VAR", "WHERE", "WHILE",
            "IDENTIFIER", "AT", "ASSIGN", "COLON", "LP", "RP", "LC", "RC", "LB", "RB", "COMMA", "SEMI", "DOT", "LT",
            "GT", "MUL", "DIV", "MINUS", "MOD", "PLUS", "IMPL", "ARROW", "AMP", "QM", "PIPE", "EXCL", "ELLIP", "EQ",
            "NE", "OR", "AND", "LE", "GE", "WHITESPACE", "NEWLINE", "LINE_COMMENT", "BLOCK_COMMENT", "INTEGER",
            "BACKTICK_LITERAL", "CHAR_LITERAL", "STRING_LITERAL" };
    }
    ...
    public static class ModuleContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterModule(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitModule(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitModule(this);
            else
    ...
    public final ModuleContext module() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0
                        && ((1L << _la) & ((1L << ATTRIBUTE) | (1L << COMPONENT) | (1L << ENUM) | (1L << EXTERNAL)
                                | (1L << FUNCTION) | (1L << IMPORT) | (1L << INSTANCE) | (1L << PORT) | (1L << PRIVATE)
                                | (1L << STRUCT) | (1L << TYPE) | (1L << VAL) | (1L << VAR) | (1L << AT))) != 0)) {
                    {
                        {
                            setState(166);
                            declaration();
    ...
    public static class DeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitDeclaration(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitDeclaration(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AttributeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterAttribute(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitAttribute(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitAttribute(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AttributeDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterAttributeDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitAttributeDeclaration(this);
        }
    ...
    public static class ImportDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterImportDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitImportDeclaration(this);
        }
    ...
    public static class VariableDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterVariableDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitVariableDeclaration(this);
        }
    ...
    public static class EnumDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEnumDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEnumDeclaration(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEnumDeclaration(this);
            else
                return visitor.visitChildren(this);
        }
    }
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                while ((((_la) & ~0x3f) == 0 && ((1L << _la)
                        & ((1L << CASE) | (1L << FUNCTION) | (1L << MUT) | (1L << MUTATING) | (1L << STATIC))) != 0)) {
                    {
                        {
                            setState(244);
                            enumElement();
    ...
    public static class StructDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStructDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStructDeclaration(this);
        }
    ...
    public final StructDeclarationContext structDeclaration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << FUNCTION) | (1L << MUT) | (1L << MUTATING)
                        | (1L << STATIC) | (1L << VAL) | (1L << VAR) | (1L << IDENTIFIER))) != 0)) {
                    {
                        {
                            setState(258);
                            structElement();
    ...
    public static class TypeAliasDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterTypeAliasDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitTypeAliasDeclaration(this);
        }
    ...
    public static class FunctionDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterFunctionDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitFunctionDeclaration(this);
        }
    ...
    public static class InstanceDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterInstanceDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitInstanceDeclaration(this);
        }
    ...
    public static class PortDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterPortDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitPortDeclaration(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitPortDeclaration(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public final PortDeclarationContext portDeclaration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ENUM) | (1L << EXTERNAL) | (1L << FUNCTION)
                        | (1L << MACHINE) | (1L << OUTGOING) | (1L << PORT) | (1L << STATIC) | (1L << STRUCT)
                        | (1L << TYPE) | (1L << VAL) | (1L << VAR) | (1L << IDENTIFIER) | (1L << AT))) != 0)) {
                    {
                        {
                            setState(309);
                            portElement();
    ...
    public static class ComponentDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterComponentDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitComponentDeclaration(this);
        }
    ...
    public final ComponentDeclarationContext componentDeclaration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INIT) | (1L << MACHINE) | (1L << PRIVATE)
                        | (1L << STATIC) | (1L << VAL) | (1L << VAR) | (1L << IDENTIFIER) | (1L << AT))) != 0)) {
                    {
                        {
                            setState(327);
                            componentElement();
    ...
    public static class ExternalConstantDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExternalConstantDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExternalConstantDeclaration(this);
        }
    ...
    public static class ExternalTypeDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExternalTypeDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExternalTypeDeclaration(this);
        }
                ...
                if (_la == LC) {
                    {
                        ...
                        _la = _input.LA(1);
                        while ((((_la) & ~0x3f) == 0
                                && ((1L << _la) & ((1L << EXTERNAL) | (1L << MUT) | (1L << MUTATING) | (1L << PRIVATE)
                                        | (1L << STATIC) | (1L << VAL) | (1L << VAR))) != 0)) {
                            {
                                {
                                    setState(347);
                                    externalTypeElement();
    ...
    public static class ExternalTypeElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExternalTypeElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExternalTypeElement(this);
        }
    ...
    public static class ExternalFunctionDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExternalFunctionDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExternalFunctionDeclaration(this);
        }
    ...
    public static class GenericTypeDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterGenericTypeDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitGenericTypeDeclaration(this);
        }
    ...
    public static class GenericTypesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterGenericTypes(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitGenericTypes(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitGenericTypes(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class GenericTypeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterGenericType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitGenericType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitGenericType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EnumElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEnumElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEnumElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEnumElement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EnumCaseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEnumCase(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEnumCase(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEnumCase(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CaseParametersContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterCaseParameters(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitCaseParameters(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitCaseParameters(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CaseParameterContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterCaseParameter(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitCaseParameter(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitCaseParameter(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StructElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStructElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStructElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitStructElement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class FieldDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterFieldDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitFieldDeclaration(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitFieldDeclaration(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ComponentElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterComponentElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitComponentElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitComponentElement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StaticMemberDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStaticMemberDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStaticMemberDeclaration(this);
        }
    ...
    public static class ConstructorDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterConstructorDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitConstructorDeclaration(this);
        }
    ...
    public static class IfExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterIfExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitIfExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitIfExpression(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class TryOperatorExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterTryOperatorExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitTryOperatorExpression(this);
        }
    ...
    public static class UnaryOperatorExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterUnaryOperatorExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitUnaryOperatorExpression(this);
        }
    ...
    public static class OptionalExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterOptionalExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitOptionalExpression(this);
        }
    ...
    public static class ArithmicOrLogicalExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterArithmicOrLogicalExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitArithmicOrLogicalExpression(this);
        }
    ...
    public static class LiteralExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterLiteralExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitLiteralExpression(this);
        }
    ...
    public static class ArrayLiteralExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterArrayLiteralExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitArrayLiteralExpression(this);
        }
    ...
    public static class NondetExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterNondetExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitNondetExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitNondetExpression(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class GroupedExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterGroupedExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitGroupedExpression(this);
        }
    ...
    public static class BlockExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterBlockExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitBlockExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitBlockExpression(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MatchExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterMatchExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitMatchExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitMatchExpression(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StructLiteralExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStructLiteralExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStructLiteralExpression(this);
        }
    ...
    public static class MemberReferenceExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterMemberReferenceExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitMemberReferenceExpression(this);
        }
    ...
    public static class AssignmentExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterAssignmentExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitAssignmentExpression(this);
        }
    ...
    public static class VariableReferenceExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterVariableReferenceExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitVariableReferenceExpression(this);
        }
    ...
    public static class ImplicitMemberExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterImplicitMemberExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitImplicitMemberExpression(this);
        }
    ...
    public static class ExternalFunctionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExternalFunction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExternalFunction(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitExternalFunction(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CastExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterCastExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitCastExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitCastExpression(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StateInvariantExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStateInvariantExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStateInvariantExpression(this);
        }
    ...
    public static class CallExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterCallExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitCallExpression(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitCallExpression(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExternalLiteralContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExternalLiteral(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExternalLiteral(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitExternalLiteral(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ArraySubscriptExpressionContext extends ExpressionContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterArraySubscriptExpression(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitArraySubscriptExpression(this);
        }
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                case 6: {
                    ...
                    if (!(((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67))
                            & ((1L << (MINUS - 67)) | (1L << (AMP - 67)) | (1L << (EXCL - 67)))) != 0))) {
                        _errHandler.recoverInline(this);
                    } else {
                        if (_input.LA(1) == Token.EOF)
                            matchedEOF = true;
                    ...
                    if (_alt == 1) {
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            case 1: {
                                ...
                                setState(522);
                                _la = _input.LA(1);
                                if (!(((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65))
                                        & ((1L << (MUL - 65)) | (1L << (DIV - 65)) | (1L << (MOD - 65)))) != 0))) {
                                    _errHandler.recoverInline(this);
                                } else {
                                    if (_input.LA(1) == Token.EOF)
                                        matchedEOF = true;
                            ...
                            case 3: {
                                ...
                                setState(528);
                                _la = _input.LA(1);
                                if (!(((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (LT - 63))
                                        | (1L << (GT - 63)) | (1L << (EQ - 63)) | (1L << (NE - 63)) | (1L << (OR - 63))
                                        | (1L << (AND - 63)) | (1L << (LE - 63)) | (1L << (GE - 63)))) != 0))) {
                                    _errHandler.recoverInline(this);
                                } else {
                                    if (_input.LA(1) == Token.EOF)
                                        matchedEOF = true;
                            ...
                            case 6: {
                                ...
                                _la = _input.LA(1);
                                if ((((_la) & ~0x3f) == 0
                                        && ((1L << _la) & ((1L << ASSERT) | (1L << EXTERNAL) | (1L << IF)
                                                | (1L << MATCH) | (1L << NONDET) | (1L << OPTIONAL) | (1L << IDENTIFIER)
                                                | (1L << LP) | (1L << LC) | (1L << LB) | (1L << DOT))) != 0)
                                        || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (MINUS - 67))
                                                | (1L << (AMP - 67)) | (1L << (EXCL - 67)) | (1L << (INTEGER - 67))
                                                | (1L << (CHAR_LITERAL - 67)) | (1L << (STRING_LITERAL - 67)))) != 0)) {
                                    {
                                        setState(538);
                                        expressions();
                                    }
    ...
    public static class BlockExpression_Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterBlockExpression_(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitBlockExpression_(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitBlockExpression_(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public final BlockExpression_Context blockExpression_() throws RecognitionException {
        ...
        try {
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ASSERT) | (1L << EXTERNAL) | (1L << IF)
                        | (1L << MATCH) | (1L << NONDET) | (1L << OPTIONAL) | (1L << IDENTIFIER) | (1L << LP)
                        | (1L << LC) | (1L << LB) | (1L << DOT))) != 0)
                        || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & ((1L << (MINUS - 67))
                                | (1L << (AMP - 67)) | (1L << (EXCL - 67)) | (1L << (INTEGER - 67))
                                | (1L << (CHAR_LITERAL - 67)) | (1L << (STRING_LITERAL - 67)))) != 0)) {
                    {
    ...
    public static class IfExpression_Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterIfExpression_(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitIfExpression_(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitIfExpression_(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MatchExpression_Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterMatchExpression_(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitMatchExpression_(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitMatchExpression_(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NondetExpression_Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterNondetExpression_(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitNondetExpression_(this);
        }
    ...
    public static class FieldAssignmentsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterFieldAssignments(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitFieldAssignments(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitFieldAssignments(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class FieldAssignmentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterFieldAssignment(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitFieldAssignment(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitFieldAssignment(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NondetClausesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterNondetClauses(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitNondetClauses(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitNondetClauses(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NondetClauseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterNondetClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitNondetClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitNondetClause(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MatchClausesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterMatchClauses(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitMatchClauses(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitMatchClauses(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class MatchClauseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterMatchClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitMatchClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitMatchClause(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class PatternContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitPattern(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EnumCasePatternContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEnumCasePattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEnumCasePattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEnumCasePattern(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class IdParameterPatternsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterIdParameterPatterns(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitIdParameterPatterns(this);
        }
    ...
    public static class IdParameterPatternContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterIdParameterPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitIdParameterPattern(this);
        }
    ...
    public static class VariableDeclarationPatternContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterVariableDeclarationPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitVariableDeclarationPattern(this);
        }
    ...
    public static class ParameterPatternsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterParameterPatterns(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitParameterPatterns(this);
        }
    ...
    public static class ParameterPatternContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterParameterPattern(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitParameterPattern(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitParameterPattern(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExpressionsContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExpressions(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExpressions(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitExpressions(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DeclarationStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterDeclarationStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitDeclarationStatement(this);
        }
    ...
    public static class ReturnStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterReturnStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitReturnStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitReturnStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class BecomeStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterBecomeStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitBecomeStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitBecomeStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class WhileStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterWhileStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitWhileStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitWhileStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ForStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterForStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitForStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitForStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class BreakStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterBreakStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitBreakStatement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitBreakStatement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ContinueStatementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterContinueStatement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitContinueStatement(this);
        }
    ...
    public static class PortElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterPortElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitPortElement(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitPortElement(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionInterfaceDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterFunctionInterfaceDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitFunctionInterfaceDeclaration(this);
        }
    ...
    public static class SignalDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterSignalDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitSignalDeclaration(this);
        }
    ...
    public static class StateMachineDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStateMachineDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStateMachineDeclaration(this);
        }
    ...
    public final StateMachineDeclarationContext stateMachineDeclaration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << AFTER) | (1L << ASSERT) | (1L << ENUM)
                        | (1L << ENTRY) | (1L << EXECUTION) | (1L << EXIT) | (1L << FUNCTION) | (1L << IF)
                        | (1L << PERIODIC) | (1L << PRIVATE) | (1L << SPONTANEOUS) | (1L << STATE) | (1L << STATIC)
                        | (1L << TYPE) | (1L << VAL) | (1L << VAR) | (1L << IDENTIFIER) | (1L << AT))) != 0)) {
                    {
                        {
                            setState(840);
    ...
    public static class StateMachineElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStateMachineElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStateMachineElement(this);
        }
    ...
    public static class StateDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStateDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStateDeclaration(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitStateDeclaration(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventStateDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEventStateDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEventStateDeclaration(this);
        }
    ...
    public final EventStateDeclarationContext eventStateDeclaration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                while ((((_la) & ~0x3f) == 0 && ((1L << _la)
                        & ((1L << AFTER) | (1L << ASSERT) | (1L << ENUM) | (1L << ENTRY) | (1L << EXECUTION)
                                | (1L << EXIT) | (1L << FUNCTION) | (1L << IF) | (1L << PERIODIC) | (1L << PRIVATE)
                                | (1L << SPONTANEOUS) | (1L << STATE) | (1L << STATIC) | (1L << STRUCT) | (1L << TYPE)
                                | (1L << VAL) | (1L << VAR) | (1L << IDENTIFIER) | (1L << AT))) != 0)) {
                    {
                        {
                            setState(880);
                            eventStateElement();
    ...
    public static class ExecutionStateDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExecutionStateDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExecutionStateDeclaration(this);
        }
    ...
    public static class EventStateElementContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEventStateElement(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEventStateElement(this);
        }
    ...
    public static class EntryFunctionDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEntryFunctionDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEntryFunctionDeclaration(this);
        }
    ...
    public static class ExitFunctionDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterExitFunctionDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitExitFunctionDeclaration(this);
        }
    ...
    public static class StateInvariantContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterStateInvariant(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitStateInvariant(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitStateInvariant(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class TransitionDeclarationContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterTransitionDeclaration(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitTransitionDeclaration(this);
        }
    ...
    public static class EventTransitionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEventTransition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEventTransition(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEventTransition(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventSourceContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEventSource(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEventSource(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEventSource(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class SpontaneousTransitionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterSpontaneousTransition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitSpontaneousTransition(this);
        }
    ...
    public static class TimerTransitionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterTimerTransition(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitTimerTransition(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitTimerTransition(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class EventHandlerContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterEventHandler(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitEventHandler(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitEventHandler(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class OfferContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterOffer(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitOffer(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitOffer(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class OfferClausesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterOfferClauses(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitOfferClauses(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitOfferClauses(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class OfferClauseContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterOfferClause(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitOfferClause(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitOfferClause(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParametersContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterParameters(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitParameters(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitParameters(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParameterContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterParameter(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitParameter(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitParameter(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class LiteralExpression_Context extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterLiteralExpression_(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitLiteralExpression_(this);
        }
    ...
    public final LiteralExpression_Context literalExpression_() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(1060);
                _la = _input.LA(1);
                if (!(((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & ((1L << (INTEGER - 87))
                        | (1L << (CHAR_LITERAL - 87)) | (1L << (STRING_LITERAL - 87)))) != 0))) {
                    _errHandler.recoverInline(this);
                } else {
                    if (_input.LA(1) == Token.EOF)
                        matchedEOF = true;
    ...
    public static class BinaryTypeContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterBinaryType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitBinaryType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitBinaryType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class GroupTypeContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterGroupType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitGroupType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitGroupType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class FunctionTypeContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterFunctionType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitFunctionType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitFunctionType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class UnaryTypeContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterUnaryType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitUnaryType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitUnaryType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class LiteralTypeContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterLiteralType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitLiteralType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitLiteralType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypeReferenceContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterTypeReference(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitTypeReference(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitTypeReference(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ReferenceTypeContext extends TypeContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterReferenceType(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitReferenceType(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitReferenceType(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class TypesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterTypes(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitTypes(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CocoVisitor)
                return ((CocoVisitor<? extends T>) visitor).visitTypes(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DotIdentifierListContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).enterDotIdentifierList(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CocoListener)
                ((CocoListener) listener).exitDotIdentifierList(this);
        }
