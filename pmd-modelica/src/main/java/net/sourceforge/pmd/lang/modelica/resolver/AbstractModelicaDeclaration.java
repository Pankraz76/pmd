...
/**
 * Internal base class for Modelica declarations, see
 * ${@link ModelicaDeclaration} for public API.
 */
abstract class AbstractModelicaDeclaration implements ModelicaDeclaration {
    /**
     * Resolves further name components, supposing previous ones resolved to this
     * declaration.
     *
     * @param result
     *            Where to place resolution results
     * @param name
     *            Further name parts to resolve
