...
abstract class TypeScriptLexerBase extends Lexer {
    ...
    /**
     * Keeps track of the current depth of nested template string backticks. E.g.
     * after the X in:
     *
     * `${a ? `${X
     *
    ...
    /**
     * Keeps track of the depth of open- and close-braces. Used for expressions
     * like:
     *
     ...
     * determine when the lexer could possibly match a regex literal. Also changes
