...
public class ScalaLanguageModule extends SimpleLanguageModuleBase {
    ...
    public ScalaLanguageModule() {
        super(LanguageMetadata.withId(ID).name("Scala").extensions("scala").addVersion("2.10").addVersion("2.11")
                .addVersion("2.12").addDefaultVersion("2.13"), new ScalaLanguageHandler());
    }
