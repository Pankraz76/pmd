...
class ConstantExpressionsTests extends BaseParserTest {
    ...
    @Test strictfp void testBitwise() {
        assertAll(
    ...
    @Test strictfp void testRelationals() {
        assertAll(
                isConst("1 <= 2L", true),
                isConst("2 <= 2d", true),
                isConst("'c' <= 6", false),
    ...
    @Test strictfp void testEquality() {
        assertAll(
                isConst("1 == 2", false),
                isConst("2 != 2d", false),
    ...
    @Test strictfp void testConditionals() {
        assertAll(
    ...
    @Test strictfp void testConstFields() {
        assertAll(
