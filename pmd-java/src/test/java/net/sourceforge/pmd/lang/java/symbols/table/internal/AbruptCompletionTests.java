...
class AbruptCompletionTests extends BaseParserTest {
    ...
    @Test void testSwitchFallthrough() {
        assertAll(
    ...
    @Test void testSwitchExhaustive() {
        assertAll(
    ...
    @Test void testFalseLoopIsUnreachable() {
        assertAll(
