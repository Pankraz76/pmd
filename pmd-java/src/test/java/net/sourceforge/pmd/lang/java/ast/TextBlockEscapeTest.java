...
class TextBlockEscapeTest extends BaseParserTest {
    ...
    @Test void testTextBlockContent() {
    ...
    @Test void emptyTextBlock() {
        assertEquals("",
                determineTextBlockContent("\"\"\"\n                       \"\"\""),
                "empty text block");
    }

    @Test void testEscapeBlockDelimiter() {
    ...
    @Test void testLineContinuation() {
    ...
    @Test void testLineEndingNormalization() {
        assertEquals("<html>\n"
                + "    <body>\n"
                + "        <p>Hello, world</p>\n"
                + "    </body>\n"
    ...
    @Test void testTextBlockWithBackslashEscape() {
        assertEquals("\\test\n",
                determineTextBlockContent("\"\"\"\n                \\\\test\n                \"\"\""),
