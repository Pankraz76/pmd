...
class AnnotationReflectionTest {
    ...
    @ParameterizedTest @EnumSource void testReflectionOfClassMethods(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testReflectionOfAnnotDefaults(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testAnnotUseThatUsesDefaults(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testAnnotOnAnnot(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testAnnotOnParameter(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testAnnotOnField(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testAnnotOnMethod(SymImplementation impl) {
    ...
    @ParameterizedTest @EnumSource void testAnnotOnConstructor(SymImplementation impl) {
    ...
    @Test void testAnnotWithInvalidType() {
