...
class Java14TreeDumpTest extends BaseJavaTreeDumpTest {
     ...
     */
    @Test void switchExpressions13ShouldFail() {
        assertThrows(ParseException.class, () -> java13.parseResource("SwitchExpressions.java"));
    }

    @Test void checkYieldConditionalBehaviour() {
        doTest("YieldStatements");
    }

    @Test void multipleCaseLabels() {
        doTest("MultipleCaseLabels");
    }

    @Test void switchRules() {
        doTest("SwitchRules");
    }

    @Test void simpleSwitchExpressions() {
