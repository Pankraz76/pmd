...
public final class JavaMetrics {
     ...
     * <ul>
     * <li>The complexity of for, do and while statements is 1, plus the complexity
     * of the block, plus the complexity of the guard condition.
     * <li>The complexity of a cascading if statement ({@code if .. else if ..}) is
     * the number of if statements in the chain, plus the complexity of their guard
     * condition, plus the complexity of the unguarded else block (or 1 if there is
     * none).
     * <li>The complexity of a switch statement is the number of cases, plus the
     * complexity of each case block. It’s equivalent to the complexity of the
     * equivalent cascade of if statements.
     * <li>The complexity of a ternary expression ({@code ? :}) is the complexity of
     * the guard condition, plus the complexity of both expressions. It’s equivalent
     * to the complexity of the equivalent {@code if .. else} construct.
     * <li>The complexity of a {@code try .. catch} statement is the complexity of
     * the {@code try} block, plus the complexity of each catch block.
     * <li>The complexity of a return statement is the complexity of the expression
     * (or 1 if there is none).
     * <li>All other statements have a complexity of 1 and are discarded from the
     * product.
     * </ul>
     * </li>
     * </ul>
