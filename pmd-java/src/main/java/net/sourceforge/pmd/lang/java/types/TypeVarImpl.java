...
abstract class TypeVarImpl implements JTypeVar {
    ...
    static final class RegularTypeVar extends TypeVarImpl {
        ...
        @Override public @NonNull JTypeParameterSymbol getSymbol() {
            return symbol;
        }
    ...
    static final class CapturedTypeVar extends TypeVarImpl {
        ...
        @Override public int hashCode() { // NOPMD UselessOverridingMethod
        ...
        @Override public JWildcardType getCapturedOrigin() {
            return wildcard;
        }
