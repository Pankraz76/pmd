...
final class WildcardTypeImpl implements JWildcardType {
    ...
    @Override public JWildcardType subst(Function<? super SubstVar, ? extends @NonNull JTypeMirror> subst) {
    ...
    @Override public JWildcardType withAnnotations(PSet<SymAnnot> newTypeAnnots) {
    ...
    @Override public @NonNull JTypeMirror getBound() {
        return bound;
    }


    @Override public boolean isUpperBound() {
        return isUpperBound;
    }
