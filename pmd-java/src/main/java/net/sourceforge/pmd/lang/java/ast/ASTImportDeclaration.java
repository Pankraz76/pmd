...
public final class ASTImportDeclaration extends AbstractJavaNode implements ASTTopLevelDeclaration {
    ...
    // @formatter:off
    /**
     * Returns true if this is an import-on-demand declaration, aka "wildcard
     * import".
     *
     * <ul>
     * <li>If this is a static import, then the imported names are those of the
     * accessible static members of the named type;
     * <li>Otherwise, the imported names are the names of the accessible types of
     * the named type or named package.
     * </ul>
     */
    // @formatter:on
