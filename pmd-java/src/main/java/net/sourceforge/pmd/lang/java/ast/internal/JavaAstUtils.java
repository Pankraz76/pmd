...
public final class JavaAstUtils {
     ...
     * {@link ASTConstructorDeclaration} or
     * {@link ASTCompactConstructorDeclaration}.
     *
     */
    public static @Nullable JavaNode getReturnTarget(ASTReturnStatement stmt) {
        return stmt.ancestors()
                .first(it -> it instanceof ASTMethodDeclaration || it instanceof ASTLambdaExpression
                        || it instanceof ASTConstructorDeclaration || it instanceof ASTInitializer
