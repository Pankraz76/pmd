...
public interface VfTypedNode extends VfNode {
    ...
    /**
     * Returns the data type this node refers to. A null value indicates that no
     * matching Metadata was found for this node. null differs from
     * {@link DataType#Unknown} which indicates that Metadata was found but it
     * wasn't mappable to one of the enums.
     *
     * <p>
