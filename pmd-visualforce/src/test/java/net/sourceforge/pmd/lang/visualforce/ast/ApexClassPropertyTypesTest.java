...
class ApexClassPropertyTypesTest {
    ...
    static {
        // Intentionally use the wrong case for property names to ensure that they can
        // be found. The Apex class name
        // must have the correct case since it is used to lookup the file. The Apex
        // class name is guaranteed to be correct
        ...
        // InnerController
        // The class should be parsed to Unknown. It's not a valid expression on its
        // own.
        ...
        /*
         * It is possible to have a property and method with different types that
         * resolve to the same Visualforce expression. An example is an Apex class with
         * a property "public String Foo {get; set;}" and a method of
         * "Integer getFoo() { return 1; }". These properties should map to {@link
         * DataType#Unknown}.
         */
