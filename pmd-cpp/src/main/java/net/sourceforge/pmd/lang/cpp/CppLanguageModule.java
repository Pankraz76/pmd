...
public class CppLanguageModule extends CpdOnlyLanguageModuleBase {
    ...
    public static final PropertyDescriptor<String> CPD_SKIP_BLOCKS = PropertyFactory
            .stringProperty("cpdSkipBlocksPattern")
    ...
    /**
     * Creates a new instance of {@link CppLanguageModule} with the default
