...
public class GherkinParser extends Parser {
    ...
    public static final int BOMUTF8 = 1, BOMUTF16 = 2, WHITESPACE = 3, COMMENT = 4, STARTCOMMENT = 5, DOCSTRING1 = 6,
            DOCSTRING2 = 7, BACKGROUND = 8, EXAMPLES = 9, FEATURE = 10, RULEX = 11, SCENARIO = 12, SCENARIOOUTLINE = 13,
            AND = 14, ANYSTEP = 15, BUT = 16, DATATABLE = 17, GIVEN = 18, THEN = 19, WHEN = 20, TAG = 21,
            PARAMETER = 22, NL = 23, TOKEN = 24;
    public static final int RULE_main = 0, RULE_feature = 1, RULE_instructionLine = 2, RULE_instruction = 3,
            RULE_stepInstruction = 4, RULE_background = 5, RULE_rulex = 6, RULE_scenario = 7, RULE_scenarioOutline = 8,
            RULE_step = 9, RULE_stepItem = 10, RULE_tagline = 11, RULE_and = 12, RULE_anystep = 13, RULE_but = 14,
            RULE_datatable = 15, RULE_given = 16, RULE_then = 17, RULE_when = 18, RULE_examples = 19,
            RULE_instructionDescription = 20, RULE_stepDescription = 21, RULE_description = 22, RULE_text = 23;

    private static String[] makeRuleNames() {
        return new String[] { "main", "feature", "instructionLine", "instruction", "stepInstruction", "background",
            "rulex", "scenario", "scenarioOutline", "step", "stepItem", "tagline", "and", "anystep", "but", "datatable",
            "given", "then", "when", "examples", "instructionDescription", "stepDescription", "description", "text" };
    }

    public static final String[] ruleNames = makeRuleNames();

    private static String[] makeLiteralNames() {
        return new String[] { null, "'\u00EF\u00BB\u00BF'", "'\uFEFF'", null, null, null, null, null, "'Background:'",
            null, "'Feature:'", "'Rule:'", null, null, "'And'", "'*'", "'But'", null, "'Given'", "'Then'", "'When'" };
    }

    private static final String[] _LITERAL_NAMES = makeLiteralNames();

    private static String[] makeSymbolicNames() {
        return new String[] { null, "BOMUTF8", "BOMUTF16", "WHITESPACE", "COMMENT", "STARTCOMMENT", "DOCSTRING1",
            "DOCSTRING2", "BACKGROUND", "EXAMPLES", "FEATURE", "RULEX", "SCENARIO", "SCENARIOOUTLINE", "AND", "ANYSTEP",
            "BUT", "DATATABLE", "GIVEN", "THEN", "WHEN", "TAG", "PARAMETER", "NL", "TOKEN" };
    }
    ...
    public static class MainContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterMain(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitMain(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitMain(this);
            else
        ...
        try {
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                while ((((_la) & ~0x3f) == 0 && ((1L << _la)
                        & ((1L << STARTCOMMENT) | (1L << SCENARIO) | (1L << SCENARIOOUTLINE) | (1L << AND)
                                | (1L << ANYSTEP) | (1L << BUT) | (1L << DATATABLE) | (1L << GIVEN) | (1L << THEN)
                                | (1L << WHEN) | (1L << TAG) | (1L << PARAMETER) | (1L << TOKEN))) != 0)) {
                    {
                        {
                            setState(52);
                            description();
    ...
    public static class FeatureContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterFeature(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitFeature(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitFeature(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class InstructionLineContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterInstructionLine(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitInstructionLine(this);
        }
    ...
    public static class InstructionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterInstruction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitInstruction(this);
        }
                        ...
                        {
                            {
                                ...
                                _errHandler.sync(this);
                                _la = _input.LA(1);
                                while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << STARTCOMMENT) | (1L << SCENARIO)
                                        | (1L << SCENARIOOUTLINE) | (1L << AND) | (1L << ANYSTEP) | (1L << BUT)
                                        | (1L << DATATABLE) | (1L << GIVEN) | (1L << THEN) | (1L << WHEN) | (1L << TAG)
                                        | (1L << PARAMETER) | (1L << TOKEN))) != 0)) {
                                    {
                                        {
                                            setState(122);
                                            description();
    ...
    public static class StepInstructionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterStepInstruction(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitStepInstruction(this);
        }
    ...
    public static class BackgroundContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterBackground(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitBackground(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitBackground(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class RulexContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterRulex(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitRulex(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitRulex(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ScenarioContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterScenario(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitScenario(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitScenario(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ScenarioOutlineContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterScenarioOutline(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitScenarioOutline(this);
        }
    ...
    public static class StepContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterStep(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitStep(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitStep(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class StepItemContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterStepItem(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitStepItem(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitStepItem(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class TaglineContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterTagline(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitTagline(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitTagline(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AndContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterAnd(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitAnd(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitAnd(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class AnystepContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterAnystep(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitAnystep(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitAnystep(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ButContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterBut(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitBut(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitBut(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class DatatableContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterDatatable(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitDatatable(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitDatatable(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class GivenContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterGiven(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitGiven(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitGiven(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ThenContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterThen(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitThen(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitThen(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class WhenContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterWhen(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitWhen(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitWhen(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class ExamplesContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterExamples(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitExamples(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitExamples(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class InstructionDescriptionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterInstructionDescription(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitInstructionDescription(this);
        }
    ...
    public static class StepDescriptionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterStepDescription(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitStepDescription(this);
        }
    ...
    public static class DescriptionContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterDescription(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitDescription(this);
        }
    ...
    public static class TextContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).enterText(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof GherkinListener)
                ((GherkinListener) listener).exitText(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof GherkinVisitor)
                return ((GherkinVisitor<? extends T>) visitor).visitText(this);
            else
                return visitor.visitChildren(this);
        }
    }
