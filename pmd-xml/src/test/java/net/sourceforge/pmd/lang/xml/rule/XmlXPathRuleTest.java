...
class XmlXPathRuleTest {
    ...
    @Test void testTextFunctionInXpath() {
    ...
    @Test void testRootNodeWildcardUri() {
    ...
    @Test void testNamespaceDescendantWrongDefaultUri() {
    ...
    @Test void testNamespaceDescendantOkUri() {
    ...
    @Test void testNamespaceDescendantWildcardUri() {
        Report report = xml.executeRule(makeXPath("//*:a"),
                "<Flow xmlns='" + A_URI + "'><a/></Flow>");
    ...
    @Test void testNamespacePrefixDescendantWildcardUri() {
        Report report = xml.executeRule(makeXPath("//*:Flow"),
    ...
    @Test void testNamespacePrefixDescendantOkUri() {
    ...
    @Test void testNamespacePrefixDescendantWrongUri() {
    ...
    @Test void testProcessingInstructions() {
    ...
    @Test void testProcessingInstructionsNamed() {
    ...
    @Test void testProcessingInstructionXML() {
